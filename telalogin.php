...
<body>
    ...
    <div class="container">
        <form method="post" action="sessao.php">
            ...
            <button type="submit" class="btn waves-effect waves-light btn-large blue">Entrar</button>
            <a href="telacadastro.php" class="waves-effect waves-light btn-large blue">Cadastrar</a>
        </form>
    </div>
